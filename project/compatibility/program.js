...
/* implicit variables: */ 
   ...
   if ( jsArray) {
      ...
      var ___v7641413 = 0; ___l0: for ( i=  1 ;  i <=  jsArray.length;  i= i + 1) { if (QB.halted()) { return; } ___v7641413++;   if (___v7641413 % 100 == 0) { await QB.autoLimit(); }
         //-------- BEGIN JS native code block --------
                part = jsArray[i-1];
//-------- END JS native code block --------
...
/* implicit variables: */ var a2 = 0;  /* SINGLE */ var a2 = QB.initArray([{l:0,u: 10}], 0);  /* SINGLE */ 
   ...
   var ___v1068624 = 0; ___l3576428: for ( j=  1 ;  j <=  arguments.length -  1;  j= j + 1) { if (QB.halted()) { return; } ___v1068624++;   if (___v1068624 % 100 == 0) { await QB.autoLimit(); }
      a2 =  arguments[j];
      //-------- BEGIN JS native code block --------
...
//-------- END JS native code block --------
         ...
         var i = 0;  /* INTEGER */ 
         var ___v480418 = 0; ___l7075312: for ( i=  1 ;  i <= (QB.func_UBound(  a2));  i= i + 1) { if (QB.halted()) { return; } ___v480418++;   if (___v480418 % 100 == 0) { await QB.autoLimit(); }
...
/* implicit variables: */ var a2 = 0;  /* SINGLE */ 
   ...
   var a = {};  /* OBJECT */ 
   a =  [];
   var ___v7288614 = 0; ___l5364588: for ( i=  0 ;  i <=  arguments.length - 1;  i= i + 1) { if (QB.halted()) { return; } ___v7288614++;   if (___v7288614 % 100 == 0) { await QB.autoLimit(); }
      a2 =  arguments[i];;
...
/* implicit variables: */ 
   var i = 0;  /* INTEGER */ 
   var ___v2480838 = 0; ___l6161923: for ( i=  1 ;  i <=  arguments.length -  1;  i= i + 1) { if (QB.halted()) { return; } ___v2480838++;   if (___v2480838 % 100 == 0) { await QB.autoLimit(); }
      //-------- BEGIN JS native code block --------
        a.push(arguments[i]);
//-------- END JS native code block --------
   } 
...
/* implicit variables: */ 
   var i = 0;  /* INTEGER */ 
   var ___v9476965 = 0; ___l4082566: for ( i=  arguments.length -  1 ;  i >=  1 ;  i= i +  - 1) { if (QB.halted()) { return; } ___v9476965++;   if (___v9476965 % 100 == 0) { await QB.autoLimit(); }
      //-------- BEGIN JS native code block --------
...
/* implicit variables: */ 
   ...
   var i = 0;  /* INTEGER */ 
   var ___v9837131 = 0; ___l7070014: for ( i=  1 ;  i <=  a.length;  i= i + 1) { if (QB.halted()) { return; } ___v9837131++;   if (___v9837131 % 100 == 0) { await QB.autoLimit(); }
...
/* global constants: */ 
/* shared variables: */ var keywords = {}; var tbody = {}; var filter = {}; var imgQBJS = ''; var imgQB = ''; var imgQB64 = ''; var imgQBPE = ''; 
/* static method variables: */ 
async function main() {
...
/* implicit variables: */ 
   keywords = {};  /* OBJECT */ tbody = {};  /* OBJECT */ filter = {};  /* OBJECT */ 
...
/* implicit variables: */ 
   tbody.innerHTML = "";
   var i = 0;  /* INTEGER */ 
   var ___v4633799 = 0; ___l4271988: for ( i=  0 ;  i <= (await JSArray.func_Length(  keywords))  -  1;  i= i + 1) { if (QB.halted()) { return; } ___v4633799++;   if (___v4633799 % 100 == 0) { await QB.autoLimit(); }
...
/* implicit variables: */ 
   ...
   if (~(QB.func_EOF(  1))  ) {
      ...
      var ___v6924219 = { value: result }; QB.sub_Get(1, undefined, 'STRING', ___v6924219); result = ___v6924219.value;
   }
   QB.sub_Close(1);
   DownloadText =  result;
return DownloadText;
...
/* implicit variables: */ 
   ...
   var i = 0;  /* INTEGER */ 
   var ___v6304556 = 0; ___l6800396: for ( i=  1 ;  i <=  3;  i= i + 1) { if (QB.halted()) { return; } ___v6304556++;   if (___v6304556 % 100 == 0) { await QB.autoLimit(); }
   ...
   var ___v5319874 = 0; ___l2269004: for ( i=  1 ;  i <=  3;  i= i + 1) { if (QB.halted()) { return; } ___v5319874++;   if (___v5319874 % 100 == 0) { await QB.autoLimit(); }
      var lines = QB.initArray([{l:0,u: 0}], '');  /* STRING */ 
      await String.sub_Split( QB.arrayValue(tables, [ i]).value  ,   (QB.func_Chr(  10))  ,    lines);
      var j = 0;  /* INTEGER */ 
      var ___v2788304 = 0; ___l209622: for ( j=  1 ;  j <= (QB.func_UBound(  lines));  j= j + 1) { if (QB.halted()) { return; } ___v2788304++;   if (___v2788304 % 100 == 0) { await QB.autoLimit(); }
         ...
         if ( i < 3 ) {
            ...
            k.levelDetail = QB.arrayValue(parts, [ 4]).value;
            k.qb64 = Math.round(  - 1 );
            k.qbpe = Math.round(  - 1 );
         }
         k.qbjs = Math.round(  - 1 );
...
/* implicit variables: */ 
   ...
   var i = 0;  /* INTEGER */ 
   var ___v1979270 = 0; ___l5183483: for ( i=  1 ;  i <=  3;  i= i + 1) { if (QB.halted()) { return; } ___v1979270++;   if (___v1979270 % 100 == 0) { await QB.autoLimit(); }
      idx = Math.round( (QB.func_InStr(  raw,   "----"  + (QB.func_Chr(  10)))) );
      raw = (QB.func_Mid(  raw,    idx + 4));
      idx = Math.round( (QB.func_InStr(  raw,   "|"  + (QB.func_Chr(  10))  + (QB.func_Chr(  10)))) );
      QB.arrayValue(tables, [ i]).value = (QB.func_Mid(  raw,    1 ,    idx - 1));
   ...
   var ___v7473842 = 0; ___l6522939: for ( i=  1 ;  i <=  3;  i= i + 1) { if (QB.halted()) { return; } ___v7473842++;   if (___v7473842 % 100 == 0) { await QB.autoLimit(); }
      var lines = QB.initArray([{l:0,u: 0}], '');  /* STRING */ 
      await String.sub_Split( QB.arrayValue(tables, [ i]).value  ,   (QB.func_Chr(  10))  ,    lines);
      var j = 0;  /* INTEGER */ 
      var ___v6907899 = 0; ___l2750404: for ( j=  1 ;  j <= (QB.func_UBound(  lines));  j= j + 1) { if (QB.halted()) { return; } ___v6907899++;   if (___v6907899 % 100 == 0) { await QB.autoLimit(); }
         ...
         if ((QB.func_Mid(  issue,    1 ,    1))  ==  "["  ) {
            var url = '';  /* STRING */ 
            idx = Math.round( (QB.func_InStr(  issue,   "(")) );
            issueUrl = (QB.func_Mid(  issue,    idx + 1 ,   (QB.func_Len(  issue))  - idx - 1));
            idx = Math.round( (QB.func_InStr(  2 ,    issue,   "]")) );
            issue = (QB.func_Mid(  issue,    2 ,    idx - 2));
            k.level = "<i>Planned</i>";
