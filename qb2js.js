...
var ConvertIntDiv = null;
   ...
   var ___v2687041 = 0; ___l3696339: while ( idx > 0) { if (QB.halted()) { return; }___v2687041++;   if (___v2687041 % 100 == 0) { await QB.autoLimit(); }
      ...
      smode =   0;
      qmode =   0;
      var ___v550793 = 0; ___l5187230: for ( eidx=  idx + 1 ;  eidx <= (QB.func_Len(  s));  eidx= eidx + 1) { if (QB.halted()) { return; } ___v550793++;   if (___v550793 % 100 == 0) { await QB.autoLimit(); }
      ...
      s =  (QB.func_Left(  s,    sidx))  + " Math.floor(QB.bround("  + (QB.func_Mid(  s,    sidx +  1 ,    idx -  sidx -  1))  + ") / QB.bround("  + (QB.func_Mid(  s,    idx +  1 ,    eidx -  idx -  1))  + "))"  + (QB.func_Mid(  s,    eidx));
      idx =  (QB.func_InStr(  s,   "\\"));
   }
   ConvertIntDiv =   s;
...
var ConvertMethodParams = null;
   ...
   var i = 0;  /* INTEGER */ 
   var ___v357299 = 0; ___l3810077: for ( i=  1 ;  i <=  argc;  i= i + 1) { if (QB.halted()) { return; } ___v357299++;   if (___v357299 % 100 == 0) { await QB.autoLimit(); }
      if ( i > 1 ) {
         js =   js + ",";
      }
...
var FindVariable = null;
   ...
   var ___v9516727 = 0; ___l8615415: for ( i=  1 ;  i <= (QB.func_UBound(  localVars));  i= i + 1) { if (QB.halted()) { return; } ___v9516727++;   if (___v9516727 % 100 == 0) { await QB.autoLimit(); }
   ...
   if (~ found) {
      var ___v5059488 = 0; ___l1660812: for ( i=  1 ;  i <= (QB.func_UBound(  globalVars));  i= i + 1) { if (QB.halted()) { return; } ___v5059488++;   if (___v5059488 % 100 == 0) { await QB.autoLimit(); }
...
var FindMethod = null;
   ...
   found =   False;
   var i = 0;  /* INTEGER */ 
   var ___v7915529 = 0; ___l2245664: for ( i=  1 ;  i <= (QB.func_UBound(  methods));  i= i + 1) { if (QB.halted()) { return; } ___v7915529++;   if (___v7915529 % 100 == 0) { await QB.autoLimit(); }
   ...
   if (~ found) {
      var ___v5360622 = 0; ___l1095753: for ( i=  1 ;  i <= (QB.func_UBound(  exportMethods));  i= i + 1) { if (QB.halted()) { return; } ___v5360622++;   if (___v5360622 % 100 == 0) { await QB.autoLimit(); }
...
if (QB.halted()) { return; }; 
   ...
   var ___v3032967 = 0; ___l8024389: for ( i=  1 ;  i <= (QB.func_UBound(  methods));  i= i + 1) { if (QB.halted()) { return; } ___v3032967++;   if (___v3032967 % 100 == 0) { await QB.autoLimit(); }
      if ((QB.arrayValue(methods, [ i]).value .line !=   0)  ) {
         ...
         if (QB.arrayValue(methods, [ i]).value .argc > 0 ) {
            ...
            var a = 0;  /* INTEGER */ 
            var ___v3082602 = 0; ___l882600: for ( a=  1 ;  a <=  c;  a= a + 1) { if (QB.halted()) { return; } ___v3082602++;   if (___v3082602 % 100 == 0) { await QB.autoLimit(); }
               var v = 0;  /* INTEGER */ 
               var parts = QB.initArray([{l:0,u:0}], '');  /* STRING */ 
   ...
   if ((QB.func_UBound(  exportLines))  > 0 ) {
      await sub_AddJSLine(  0 ,   "return {");
      var ___v7516135 = 0; ___l6110892: for ( i=  1 ;  i <= (QB.func_UBound(  exportLines));  i= i + 1) { if (QB.halted()) { return; } ___v7516135++;   if (___v7516135 % 100 == 0) { await QB.autoLimit(); }
...
if (QB.halted()) { return; }; 
   ...
   var ___v8299279 = 0; ___l3705068: while (!((QB.func_EOF(  1)))) { if (QB.halted()) { return; }___v8299279++;   if (___v8299279 % 100 == 0) { await QB.autoLimit(); }
      var ___v1908614 = new Array(1); await QB.sub_LineInputFromFile(1, ___v1908614);  fline = ___v1908614[0]; 
      lineIndex =   lineIndex +  1;
      if ((QB.func__Trim(  fline))  !=  ""  ) {
         var ___v9444140 = 0; ___l8279706: while ((await func_EndsWith(  fline,   " _"))) { if (QB.halted()) { return; }___v9444140++;   if (___v9444140 % 100 == 0) { await QB.autoLimit(); }
            var nextLine = '';  /* STRING */ 
            var ___v9492710 = new Array(1); await QB.sub_LineInputFromFile(1, ___v9492710);  nextLine = ___v9492710[0]; 
...
if (QB.halted()) { return; }; 
   ...
   var ___v7912182 = 0; ___l5596389: for ( i=  1 ;  i <=  lcount;  i= i + 1) { if (QB.halted()) { return; } ___v7912182++;   if (___v7912182 % 100 == 0) { await QB.autoLimit(); }
      var fline = '';  /* STRING */ 
      ...
      if ((QB.func__Trim(  fline))  !=  ""  ) {
         ...
         var ___v6209402 = 0; ___l959311: while ((await func_EndsWith(  fline,   " _"))) { if (QB.halted()) { return; }___v6209402++;   if (___v6209402 % 100 == 0) { await QB.autoLimit(); }
            i =   i +  1;
            var nextLine = '';  /* STRING */ 
...
var ReadLine = null;
   ...
   quoteDepth =   0;
   var i = 0;  /* INTEGER */ 
   var ___v8582140 = 0; ___l4159691: for ( i=  1 ;  i <= (QB.func_Len(  fline));  i= i + 1) { if (QB.halted()) { return; } ___v8582140++;   if (___v8582140 % 100 == 0) { await QB.autoLimit(); }
   ...
   if ((QB.func_UCase( QB.arrayValue(words, [ 1]).value))  ==  "DATA"  ) {
      ...
      var ___v4216568 = 0; ___l2369846: for ( i=  1 ;  i <=  dcount;  i= i + 1) { if (QB.halted()) { return; } ___v4216568++;   if (___v4216568 % 100 == 0) { await QB.autoLimit(); }
   ...
   var ___v8444489 = 0; ___l5921883: for ( i=  1 ;  i <=  wcount;  i= i + 1) { if (QB.halted()) { return; } ___v8444489++;   if (___v8444489 % 100 == 0) { await QB.autoLimit(); }
...
if (QB.halted()) { return; }; lineIndex = Math.round(lineIndex); 
   ...
   quoteDepth =   0;
   var i = 0;  /* INTEGER */ 
   var ___v3158374 = 0; ___l9836021: for ( i=  1 ;  i <= (QB.func_Len(  fline));  i= i + 1) { if (QB.halted()) { return; } ___v3158374++;   if (___v3158374 % 100 == 0) { await QB.autoLimit(); }
      var c = '';  /* STRING */ 
      c =  (QB.func_Mid(  fline,    i,    1));
      if ( c ==  (QB.func_Chr(  34))  ) {
         if ( quoteDepth ==   0 ) {
...
if (QB.halted()) { return; }; 
   ...
   var rawJS = 0;  /* INTEGER */ 
   var parts = QB.initArray([{l:0,u:0}], '');  /* STRING */ 
   var ___v546714 = 0; ___l7575471: for ( i=  1 ;  i <= (QB.func_UBound(  lines));  i= i + 1) { if (QB.halted()) { return; } ___v546714++;   if (___v546714 % 100 == 0) { await QB.autoLimit(); }
      ...
      if ( word ==  "FUNCTION"  |  word ==  "SUB"  ) {
         ...
         if ((QB.func_UBound(  arga))  > 0 ) {
            ...
            var args = '';  /* STRING */ 
            args =  "";
            var ___v6712186 = 0; ___l4840382: for ( a=  1 ;  a <=  m.argc;  a= a + 1) { if (QB.halted()) { return; } ___v6712186++;   if (___v6712186 % 100 == 0) { await QB.autoLimit(); }
...
var Split = null;
   ...
   if ( delimiter ==  " "  ) {
      ...
      var ___v4235128 = 0; ___l3713350: while ( p > 0) { if (QB.halted()) { return; }___v4235128++;   if (___v4235128 % 100 == 0) { await QB.autoLimit(); }
   ...
   var ___v5244827 = 0; ___l9968987: while (!( dpos ==   0)) { if (QB.halted()) { return; }___v5244827++;   if (___v5244827 % 100 == 0) { await QB.autoLimit(); }
      arrpos =   arrpos +  1;
...
var SLSplit = null;
   ...
   var count = 0;  /* INTEGER */ 
   var i = 0;  /* INTEGER */ 
   var ___v9061123 = 0; ___l8860056: for ( i=  1 ;  i <= (QB.func_Len(  cstr));  i= i + 1) { if (QB.halted()) { return; } ___v9061123++;   if (___v9061123 % 100 == 0) { await QB.autoLimit(); }
...
if (QB.halted()) { return; }; lineNumber = Math.round(lineNumber); 
   ...
   var quoteMode = 0;  /* INTEGER */ 
   var paren = 0;  /* INTEGER */ 
   var ___v968821 = 0; ___l7192662: for ( i=  1 ;  i <= (QB.func_Len(  sourceString));  i= i + 1) { if (QB.halted()) { return; } ___v968821++;   if (___v968821 % 100 == 0) { await QB.autoLimit(); }
      var c = '';  /* STRING */ 
...
var SLSplit2 = null;
   ...
   var count = 0;  /* INTEGER */ 
   var i = 0;  /* INTEGER */ 
   var ___v1187419 = 0; ___l2003016: for ( i=  1 ;  i <= (QB.func_Len(  cstr));  i= i + 1) { if (QB.halted()) { return; } ___v1187419++;   if (___v1187419 % 100 == 0) { await QB.autoLimit(); }
      var c = '';  /* STRING */ 
      c =  (QB.func_Mid(  cstr,    i,    1));
      if ( c ==  (QB.func_Chr(  34))  ) {
         quoteMode =  ~ quoteMode;
...
if (QB.halted()) { return; }; 
   ...
   await QB.sub_Print(["------------------------------------------------------------"]);
   var i = 0;  /* INTEGER */ 
   var ___v506980 = 0; ___l9919851: for ( i=  1 ;  i <= (QB.func_UBound(  methods));  i= i + 1) { if (QB.halted()) { return; } ___v506980++;   if (___v506980 % 100 == 0) { await QB.autoLimit(); }
      var m = {line:0,type:'',returnType:'',name:'',uname:'',argc:0,args:'',jsname:'',sync:0,builtin:0};  /* METHOD */ 
...
if (QB.halted()) { return; }; 
   ...
   await QB.sub_Print(["------------------------------------------------------------"]);
   var i = 0;  /* INTEGER */ 
   var ___v985931 = 0; ___l5229358: for ( i=  1 ;  i <= (QB.func_UBound(  types));  i= i + 1) { if (QB.halted()) { return; } ___v985931++;   if (___v985931 % 100 == 0) { await QB.autoLimit(); }
      var t = {line:0,name:'',argc:0,args:''};  /* QBTYPE */ 
      t =  QB.arrayValue(types, [ i]).value;
      await QB.sub_Print([(QB.func_Str(  t.line))  + ": "  +  t.name]);
      var v = 0;  /* INTEGER */ 
      var ___v9380960 = 0; ___l5820094: for ( v=  1 ;  v <= (QB.func_UBound(  typeVars));  v= v + 1) { if (QB.halted()) { return; } ___v9380960++;   if (___v9380960 % 100 == 0) { await QB.autoLimit(); }
...
if (QB.halted()) { return; }; 
   ...
   var i = 0;  /* INTEGER */ 
   var ___v6696478 = 0; ___l1383297: for ( i=  1 ;  i <= (QB.func_UBound(  pairs));  i= i + 1) { if (QB.halted()) { return; } ___v6696478++;   if (___v6696478 % 100 == 0) { await QB.autoLimit(); }
...
var RemoveSuffix = null;
   ...
   i =  (QB.func_Len(  vname));
   var ___v3378422 = 0; ___l8671363: while (~ done) { if (QB.halted()) { return; }___v3378422++;   if (___v3378422 % 100 == 0) { await QB.autoLimit(); }
...
var IsJSReservedWord = null;
   ...
   var ___v6096486 = 0; ___l4237103: for ( i=  1 ;  i <= (QB.func_UBound(  jsReservedWords));  i= i + 1) { if (QB.halted()) { return; } ___v6096486++;   if (___v6096486 % 100 == 0) { await QB.autoLimit(); }
...
var Join = null;
   ...
   var s = '';  /* STRING */ 
   var i = 0;  /* INTEGER */ 
   var ___v8784156 = 0; ___l9087062: for ( i=  startIndex;  i <=  endIndex;  i= i + 1) { if (QB.halted()) { return; } ___v8784156++;   if (___v8784156 % 100 == 0) { await QB.autoLimit(); }
...
var Replace = null;
   ...
   var ___v1999065 = 0; ___l561406: for ( i=  1 ;  i <= (QB.func_Len(  s));  i= i + 1) { if (QB.halted()) { return; } ___v1999065++;   if (___v1999065 % 100 == 0) { await QB.autoLimit(); }
...
var MethodJS = null;
   ...
   var c = '';  /* STRING */ 
   var a = 0;  /* INTEGER */ 
   var ___v7166154 = 0; ___l9252861: for ( i=  1 ;  i <= (QB.func_Len(  m.name));  i= i + 1) { if (QB.halted()) { return; } ___v7166154++;   if (___v7166154 % 100 == 0) { await QB.autoLimit(); }
...
var GXMethodJS = null;
   ...
   var c = '';  /* STRING */ 
   var a = 0;  /* INTEGER */ 
   var ___v4766153 = 0; ___l1277227: for ( i=  startIdx +  1 ;  i <= (QB.func_Len(  mname));  i= i + 1) { if (QB.halted()) { return; } ___v4766153++;   if (___v4766153 % 100 == 0) { await QB.autoLimit(); }
