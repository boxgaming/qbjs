   ...
   if ( m.name ==  "Line"  |  m.name ==  "_Clipboard$"  |  m.name ==  "_ClipboardImage" ) {
      ...
      if ( plen > 0) {
         if ((QB.func_UCase( QB.arrayValue(parts, [ 1]).value))  ==  "INPUT" ) {
            ...
            var ___v5891630 =  m.name; switch (___v5891630) {
               case "_Clipboard$": 
...
var ConvertSubName = null;
   ...
   var i = 0;  /* INTEGER */ 
   var ___v9109643 = 0; ___l9860932: for ( i=  1;  i <=  argc;  i= i + 1) { if (QB.halted()) { return; } ___v9109643++;   if (___v9109643 % 100 == 0) { await QB.autoLimit(); }
...
var ConvertRead = null;
   ...
   var i = 0;  /* INTEGER */ 
   var ___v6951155 = 0; ___l2268660: for ( i=  1;  i <=  pcount;  i= i + 1) { if (QB.halted()) { return; } ___v6951155++;   if (___v6951155 % 100 == 0) { await QB.autoLimit(); }
   ...
   var ___v2439314 = 0; ___l9800032: for ( i=  1;  i <= (QB.func_UBound(  vars));  i= i + 1) { if (QB.halted()) { return; } ___v2439314++;   if (___v2439314 % 100 == 0) { await QB.autoLimit(); }
...
var ConvertPrint = null;
   ...
   js =   js + "[";
   var i = 0;  /* INTEGER */ 
   var ___v1063697 = 0; ___l5338731: for ( i=  startIdx;  i <=  pcount;  i= i + 1) { if (QB.halted()) { return; } ___v1063697++;   if (___v1063697 % 100 == 0) { await QB.autoLimit(); }
      if ( i > startIdx) {
         js =   js + ",";
      }
...
var ConvertWrite = null;
   ...
   js =   js + "[";
   var i = 0;  /* INTEGER */ 
   var ___v6761759 = 0; ___l9994146: for ( i=  startIdx;  i <=  pcount;  i= i + 1) { if (QB.halted()) { return; } ___v6761759++;   if (___v6761759 % 100 == 0) { await QB.autoLimit(); }
      if ( i > startIdx) {
         js =   js + ",";
      }
      var t = '';  /* STRING */ 
...
var ConvertInput = null;
   ...
   var prompt_157039 = '';  /* STRING */ 
   prompt_157039 =  "undefined";
   var vcount = 0;  /* INTEGER */ 
   var p = '';  /* STRING */ 
   pcount =  (await func_PrintSplit(  args,   parts));
   var i = 0;  /* INTEGER */ 
   var ___v1000522 = 0; ___l5751838: for ( i=  1;  i <=  pcount;  i= i + 1) { if (QB.halted()) { return; } ___v1000522++;   if (___v1000522 % 100 == 0) { await QB.autoLimit(); }
      p =  (QB.func__Trim( QB.arrayValue(parts, [ i]).value));
      if ( p ==  ";" ) {
         if ( i ==   1) {
            preventNewline =  "true";
   ...
   vname =  await func_GenJSVar();
   js =  "var "  +  vname + " = new Array("  + (QB.func_Str( (QB.func_UBound(  vars))))  + "); ";
   js =   js + (await func_CallMethod(  m))  + "("  +  vname + ", "  +  preventNewline + ", "  +  addQuestionPrompt + ", "  +  prompt_157039 + "); ";
   var ___v7988844 = 0; ___l1030226: for ( i=  1;  i <= (QB.func_UBound(  vars));  i= i + 1) { if (QB.halted()) { return; } ___v7988844++;   if (___v7988844 % 100 == 0) { await QB.autoLimit(); }
      var vartype = '';  /* STRING */ 
...
var ConvertFileInput = null;
   ...
   js =   js + (await func_CallMethod(  m))  + "("  +  fh + ", "  +  vname + "); ";
   var i = 0;  /* INTEGER */ 
   var ___v456492 = 0; ___l2844803: for ( i=  2;  i <= (QB.func_UBound(  parts));  i= i + 1) { if (QB.halted()) { return; } ___v456492++;   if (___v456492 % 100 == 0) { await QB.autoLimit(); }
      var vartype = '';  /* STRING */ 
...
var GetVarType = null;
   ...
   if ( pcount ==   1) {
      ...
      if ( found) {
         ...
         var i = 0;  /* INTEGER */ 
         var j = 0;  /* INTEGER */ 
         var ___v3820107 = 0; ___l2957728: for ( i=  2;  i <=  pcount;  i= i + 1) { if (QB.halted()) { return; } ___v3820107++;   if (___v3820107 % 100 == 0) { await QB.autoLimit(); }
            var ___v9485711 = 0; ___l3009705: for ( j=  1;  j <= (QB.func_UBound(  typeVars));  j= j + 1) { if (QB.halted()) { return; } ___v9485711++;   if (___v9485711 % 100 == 0) { await QB.autoLimit(); }
...
var FindParamChar = null;
   ...
   var paren = 0;  /* INTEGER */ 
   var i = 0;  /* INTEGER */ 
   var ___v2782800 = 0; ___l4013744: for ( i=  1;  i <= (QB.func_Len(  s));  i= i + 1) { if (QB.halted()) { return; } ___v2782800++;   if (___v2782800 % 100 == 0) { await QB.autoLimit(); }
      c =  (QB.func_Mid(  s,    i,    1));
      if ( c ==  (QB.func_Chr(  34)) ) {
         quote =  ~ quote;
      } else if (~ quote &  c ==  "(" ) {
...
if (QB.halted()) { return; }; 
   ...
   bvar.typeId =   typeId;
   var i = 0;  /* INTEGER */ 
   var ___v1628216 = 0; ___l1604415: for ( i=  1;  i <= (QB.func_UBound(  parts));  i= i + 1) { if (QB.halted()) { return; } ___v1628216++;   if (___v1628216 % 100 == 0) { await QB.autoLimit(); }
      if ((QB.func_UCase( QB.arrayValue(parts, [ i]).value))  ==  "AS" ) {
         asIdx =   i;
      }
   } 
   if ( asIdx ==   1) {
      ...
      var ___v4100732 = 0; ___l6465872: for ( i=  1;  i <=  vnamecount;  i= i + 1) { if (QB.halted()) { return; } ___v4100732++;   if (___v4100732 % 100 == 0) { await QB.autoLimit(); }
...
var DeclareVar = null;
   ...
   var i = 0;  /* INTEGER */ 
   var ___v7127304 = 0; ___l4127668: for ( i=  1;  i <= (QB.func_UBound(  parts));  i= i + 1) { if (QB.halted()) { return; } ___v7127304++;   if (___v7127304 % 100 == 0) { await QB.autoLimit(); }
      if ((QB.func_UCase( QB.arrayValue(parts, [ i]).value))  ==  "AS" ) {
         asIdx =   i;
      }
   ...
   if ( asIdx ==   2 | ( asIdx ==   3 & ( isGlobal |  preserve ==  "true"))  | ( asIdx ==   4 &  isGlobal &  preserve ==  "true") ) {
      ...
      vnamecount =  (await func_ListSplit( (await func_Join( parts ,    nextIdx,    - 1,   " ")) ,   varnames));
      var ___v6331789 = 0; ___l3262062: for ( i=  1;  i <=  vnamecount;  i= i + 1) { if (QB.halted()) { return; } ___v6331789++;   if (___v6331789 % 100 == 0) { await QB.autoLimit(); }
         vname =  (QB.func__Trim( QB.arrayValue(varnames, [ i]).value));
         pstart =  (QB.func_InStr(  vname,   "("));
         if ( pstart > 0) {
            bvar.isArray =   True;
      ...
      nextIdx =   0;
      var ___v1860135 = 0; ___l2075611: for ( i=  1;  i <= (QB.func_UBound(  parts));  i= i + 1) { if (QB.halted()) { return; } ___v1860135++;   if (___v1860135 % 100 == 0) { await QB.autoLimit(); }
         var p = '';  /* STRING */ 
      ...
      vnamecount =  (await func_ListSplit( (await func_Join( parts ,    nextIdx,    - 1,   " ")) ,   varnames));
      var ___v807146 = 0; ___l5833590: for ( i=  1;  i <=  vnamecount;  i= i + 1) { if (QB.halted()) { return; } ___v807146++;   if (___v807146 % 100 == 0) { await QB.autoLimit(); }
...
var FormatArraySize = null;
   ...
   var i = 0;  /* INTEGER */ 
   var ___v9057298 = 0; ___l4579714: for ( i=  1;  i <=  pcount;  i= i + 1) { if (QB.halted()) { return; } ___v9057298++;   if (___v9057298 % 100 == 0) { await QB.autoLimit(); }
      ...
      toIndex =   0;
      var ___v7852122 = 0; ___l2613683: for ( j=  0;  j <=  scount;  j= j + 1) { if (QB.halted()) { return; } ___v7852122++;   if (___v7852122 % 100 == 0) { await QB.autoLimit(); }
...
var InitTypeValue = null;
   ...
   if ( vtype ==  "STRING" ) {
      ...
      var i = 0;  /* INTEGER */ 
      var ___v2896650 = 0; ___l3789026: for ( i=  1;  i <= (QB.func_UBound(  typeVars));  i= i + 1) { if (QB.halted()) { return; } ___v2896650++;   if (___v2896650 % 100 == 0) { await QB.autoLimit(); }
...
var FindTypeId = null;
   ...
   id =   - 1;
   var i = 0;  /* INTEGER */ 
   var ___v6317424 = 0; ___l9193771: for ( i=  1;  i <= (QB.func_UBound(  types));  i= i + 1) { if (QB.halted()) { return; } ___v6317424++;   if (___v6317424 % 100 == 0) { await QB.autoLimit(); }
...
var ConvertExpression = null;
   ...
   var i = 0;  /* INTEGER */ 
   i =   1;
   var ___v4284564 = 0; ___l6276420: while ( i <= (QB.func_Len(  ex))) { if (QB.halted()) { return; }___v4284564++;   if (___v4284564 % 100 == 0) { await QB.autoLimit(); }
      ...
      if ( c ==  (QB.func_Chr(  34)) ) {
         ...
         if ( c ==  " "  |  c ==  ","  |  i ==  (QB.func_Len(  ex)) ) {
            ...
            i =   i +  1;
            var ___v5610401 = 0; ___l979738: while (~ done &  i <= (QB.func_Len(  ex))) { if (QB.halted()) { return; }___v5610401++;   if (___v5610401 % 100 == 0) { await QB.autoLimit(); }
...
var ConvertIntDiv = null;
   ...
   var c = '';  /* STRING */ 
   idx =  (QB.func_InStr(  s,   "\\"));
   var ___v9137176 = 0; ___l6944853: while ( idx > 0) { if (QB.halted()) { return; }___v9137176++;   if (___v9137176 % 100 == 0) { await QB.autoLimit(); }
      smode =   0;
      qmode =   0;
      pcount =   0;
      var ___v226292 = 0; ___l8348172: for ( sidx=  idx -  1;  sidx >=  1;  sidx= sidx +  - 1) { if (QB.halted()) { return; } ___v226292++;   if (___v226292 % 100 == 0) { await QB.autoLimit(); }
         c =  (QB.func_Mid(  s,    sidx,    1));
         if ( c ==  " " ) {
            if ( smode ==   0) {
            } else if ( smode ==   1) {
               if ( pcount <=  0) {
                  var ___v9161640 = 0; ___l5433606: for ( ci=  sidx -  1;  ci >=  1;  ci= ci +  - 1) { if (QB.halted()) { return; } ___v9161640++;   if (___v9161640 % 100 == 0) { await QB.autoLimit(); }
      ...
      smode =   0;
      qmode =   0;
      var ___v6779477 = 0; ___l4302612: for ( eidx=  idx +  1;  eidx <= (QB.func_Len(  s));  eidx= eidx + 1) { if (QB.halted()) { return; } ___v6779477++;   if (___v6779477 % 100 == 0) { await QB.autoLimit(); }
...
var ConvertMethodParams = null;
   ...
   var i = 0;  /* INTEGER */ 
   var ___v5137375 = 0; ___l5024539: for ( i=  1;  i <=  argc;  i= i + 1) { if (QB.halted()) { return; } ___v5137375++;   if (___v5137375 % 100 == 0) { await QB.autoLimit(); }
      if ( i > 1) {
         js =   js + ",";
      }
...
var FindVariable = null;
   ...
   var ___v3534726 = 0; ___l4629800: for ( i=  1;  i <= (QB.func_UBound(  localVars));  i= i + 1) { if (QB.halted()) { return; } ___v3534726++;   if (___v3534726 % 100 == 0) { await QB.autoLimit(); }
   ...
   if (~ found) {
      var ___v2697316 = 0; ___l4048342: for ( i=  1;  i <= (QB.func_UBound(  globalVars));  i= i + 1) { if (QB.halted()) { return; } ___v2697316++;   if (___v2697316 % 100 == 0) { await QB.autoLimit(); }
...
var FindMethod = null;
   ...
   found =   False;
   var i = 0;  /* INTEGER */ 
   var ___v2438452 = 0; ___l555935: for ( i=  1;  i <= (QB.func_UBound(  methods));  i= i + 1) { if (QB.halted()) { return; } ___v2438452++;   if (___v2438452 % 100 == 0) { await QB.autoLimit(); }
   ...
   if (~ found) {
      var ___v609162 = 0; ___l9790779: for ( i=  1;  i <= (QB.func_UBound(  exportMethods));  i= i + 1) { if (QB.halted()) { return; } ___v609162++;   if (___v609162 % 100 == 0) { await QB.autoLimit(); }
...
if (QB.halted()) { return; }; 
   await sub_AddJSLine(  0,   "");
   var i = 0;  /* INTEGER */ 
   var ___v3649954 = 0; ___l3902914: for ( i=  1;  i <= (QB.func_UBound(  methods));  i= i + 1) { if (QB.halted()) { return; } ___v3649954++;   if (___v3649954 % 100 == 0) { await QB.autoLimit(); }
      if ((QB.arrayValue(methods, [ i]).value .line !=   0) ) {
         ...
         if (QB.arrayValue(methods, [ i]).value .argc > 0) {
            ...
            var a = 0;  /* INTEGER */ 
            var ___v1556631 = 0; ___l4898948: for ( a=  1;  a <=  c;  a= a + 1) { if (QB.halted()) { return; } ___v1556631++;   if (___v1556631 % 100 == 0) { await QB.autoLimit(); }
               var v = 0;  /* INTEGER */ 
               var parts = QB.initArray([{l:0,u:0}], '');  /* STRING */ 
   ...
   if ((QB.func_UBound(  exportLines))  > 0) {
      await sub_AddJSLine(  0,   "return {");
      var ___v2572676 = 0; ___l4744592: for ( i=  1;  i <= (QB.func_UBound(  exportLines));  i= i + 1) { if (QB.halted()) { return; } ___v2572676++;   if (___v2572676 % 100 == 0) { await QB.autoLimit(); }
...
if (QB.halted()) { return; }; 
   ...
   var ___v5420702 = 0; ___l6287518: while (!((QB.func_EOF(  1)))) { if (QB.halted()) { return; }___v5420702++;   if (___v5420702 % 100 == 0) { await QB.autoLimit(); }
      var ___v1563022 = new Array(1); await QB.sub_LineInputFromFile(1, ___v1563022);  fline = ___v1563022[0]; 
      lineIndex =   lineIndex +  1;
      if ((QB.func__Trim(  fline))  !=  "" ) {
         var ___v6544994 = 0; ___l9385452: while ((await func_EndsWith(  fline,   " _"))) { if (QB.halted()) { return; }___v6544994++;   if (___v6544994 % 100 == 0) { await QB.autoLimit(); }
            var nextLine = '';  /* STRING */ 
            var ___v5060874 = new Array(1); await QB.sub_LineInputFromFile(1, ___v5060874);  nextLine = ___v5060874[0]; 
...
if (QB.halted()) { return; }; 
   ...
   var ___v1073753 = 0; ___l3904714: for ( i=  1;  i <=  lcount;  i= i + 1) { if (QB.halted()) { return; } ___v1073753++;   if (___v1073753 % 100 == 0) { await QB.autoLimit(); }
      var fline = '';  /* STRING */ 
      ...
      if ((QB.func__Trim(  fline))  !=  "" ) {
         ...
         var ___v4596408 = 0; ___l7839952: while ((await func_EndsWith(  fline,   " _"))) { if (QB.halted()) { return; }___v4596408++;   if (___v4596408 % 100 == 0) { await QB.autoLimit(); }
            i =   i +  1;
            var nextLine = '';  /* STRING */ 
...
var ReadLine = null;
   ...
   quoteDepth =   0;
   var i = 0;  /* INTEGER */ 
   var ___v5960946 = 0; ___l7536881: for ( i=  1;  i <= (QB.func_Len(  fline));  i= i + 1) { if (QB.halted()) { return; } ___v5960946++;   if (___v5960946 % 100 == 0) { await QB.autoLimit(); }
   ...
   if ((QB.func_UCase( QB.arrayValue(words, [ 1]).value))  ==  "DATA" ) {
      ...
      var ___v187584 = 0; ___l8327302: for ( i=  1;  i <=  dcount;  i= i + 1) { if (QB.halted()) { return; } ___v187584++;   if (___v187584 % 100 == 0) { await QB.autoLimit(); }
   ...
   var ___v739533 = 0; ___l2103686: for ( i=  1;  i <=  wcount;  i= i + 1) { if (QB.halted()) { return; } ___v739533++;   if (___v739533 % 100 == 0) { await QB.autoLimit(); }
...
if (QB.halted()) { return; }; 
   ...
   quoteDepth =   0;
   var i = 0;  /* INTEGER */ 
   var ___v3316944 = 0; ___l1054527: for ( i=  1;  i <= (QB.func_Len(  fline));  i= i + 1) { if (QB.halted()) { return; } ___v3316944++;   if (___v3316944 % 100 == 0) { await QB.autoLimit(); }
      var c = '';  /* STRING */ 
      c =  (QB.func_Mid(  fline,    i,    1));
      if ( c ==  (QB.func_Chr(  34)) ) {
         if ( quoteDepth ==   0) {
...
if (QB.halted()) { return; }; 
   ...
   var rawJS = 0;  /* INTEGER */ 
   var parts = QB.initArray([{l:0,u:0}], '');  /* STRING */ 
   var ___v2412 = 0; ___l1282499: for ( i=  1;  i <= (QB.func_UBound(  lines));  i= i + 1) { if (QB.halted()) { return; } ___v2412++;   if (___v2412 % 100 == 0) { await QB.autoLimit(); }
      ...
      if ( word ==  "FUNCTION"  |  word ==  "SUB" ) {
         ...
         if ((QB.func_UBound(  arga))  > 0) {
            ...
            var args = '';  /* STRING */ 
            args =  "";
            var ___v6570550 = 0; ___l5367940: for ( a=  1;  a <=  m.argc;  a= a + 1) { if (QB.halted()) { return; } ___v6570550++;   if (___v6570550 % 100 == 0) { await QB.autoLimit(); }
...
var Split = null;
   ...
   if ( delimiter ==  " " ) {
      ...
      var ___v8274118 = 0; ___l5440140: while ( p > 0) { if (QB.halted()) { return; }___v8274118++;   if (___v8274118 % 100 == 0) { await QB.autoLimit(); }
   ...
   var ___v1919225 = 0; ___l818936: while (!( dpos ==   0)) { if (QB.halted()) { return; }___v1919225++;   if (___v1919225 % 100 == 0) { await QB.autoLimit(); }
      arrpos =   arrpos +  1;
...
var SLSplit = null;
   ...
   var count = 0;  /* INTEGER */ 
   var i = 0;  /* INTEGER */ 
   var ___v4542078 = 0; ___l6789134: for ( i=  1;  i <= (QB.func_Len(  cstr));  i= i + 1) { if (QB.halted()) { return; } ___v4542078++;   if (___v4542078 % 100 == 0) { await QB.autoLimit(); }
...
if (QB.halted()) { return; }; 
   ...
   var quoteMode = 0;  /* INTEGER */ 
   var paren = 0;  /* INTEGER */ 
   var ___v1499811 = 0; ___l3570231: for ( i=  1;  i <= (QB.func_Len(  sourceString));  i= i + 1) { if (QB.halted()) { return; } ___v1499811++;   if (___v1499811 % 100 == 0) { await QB.autoLimit(); }
      var c = '';  /* STRING */ 
...
var SLSplit2 = null;
   ...
   var count = 0;  /* INTEGER */ 
   var i = 0;  /* INTEGER */ 
   var ___v9287860 = 0; ___l7043958: for ( i=  1;  i <= (QB.func_Len(  cstr));  i= i + 1) { if (QB.halted()) { return; } ___v9287860++;   if (___v9287860 % 100 == 0) { await QB.autoLimit(); }
      var c = '';  /* STRING */ 
      c =  (QB.func_Mid(  cstr,    i,    1));
      if ( c ==  (QB.func_Chr(  34)) ) {
         quoteMode =  ~ quoteMode;
...
var ListSplit = null;
   ...
   var paren = 0;  /* INTEGER */ 
   var i = 0;  /* INTEGER */ 
   var ___v896414 = 0; ___l5302125: for ( i=  1;  i <= (QB.func_Len(  cstr));  i= i + 1) { if (QB.halted()) { return; } ___v896414++;   if (___v896414 % 100 == 0) { await QB.autoLimit(); }
      var c = '';  /* STRING */ 
      c =  (QB.func_Mid(  cstr,    i,    1));
      if ( c ==  (QB.func_Chr(  34)) ) {
         quoteMode =  ~ quoteMode;
...
var PrintSplit = null;
   ...
   var paren = 0;  /* INTEGER */ 
   var i = 0;  /* INTEGER */ 
   var ___v4018420 = 0; ___l7577293: for ( i=  1;  i <= (QB.func_Len(  cstr));  i= i + 1) { if (QB.halted()) { return; } ___v4018420++;   if (___v4018420 % 100 == 0) { await QB.autoLimit(); }
      var c = '';  /* STRING */ 
      c =  (QB.func_Mid(  cstr,    i,    1));
      if ( c ==  (QB.func_Chr(  34)) ) {
         quoteMode =  ~ quoteMode;
...
if (QB.halted()) { return; }; 
   ...
   await QB.sub_Print(["------------------------------------------------------------"]);
   var i = 0;  /* INTEGER */ 
   var ___v4921656 = 0; ___l4618744: for ( i=  1;  i <= (QB.func_UBound(  methods));  i= i + 1) { if (QB.halted()) { return; } ___v4921656++;   if (___v4921656 % 100 == 0) { await QB.autoLimit(); }
      var m = {line:0,type:'',returnType:'',name:'',uname:'',argc:0,args:'',jsname:'',sync:0,builtin:0};  /* METHOD */ 
...
if (QB.halted()) { return; }; 
   ...
   await QB.sub_Print(["------------------------------------------------------------"]);
   var i = 0;  /* INTEGER */ 
   var ___v3297359 = 0; ___l2076273: for ( i=  1;  i <= (QB.func_UBound(  types));  i= i + 1) { if (QB.halted()) { return; } ___v3297359++;   if (___v3297359 % 100 == 0) { await QB.autoLimit(); }
      var t = {line:0,name:'',argc:0,args:''};  /* QBTYPE */ 
      t =  QB.arrayValue(types, [ i]).value;
      await QB.sub_Print([(QB.func_Str(  t.line))  + ": "  +  t.name]);
      var v = 0;  /* INTEGER */ 
      var ___v5897926 = 0; ___l954291: for ( v=  1;  v <= (QB.func_UBound(  typeVars));  v= v + 1) { if (QB.halted()) { return; } ___v5897926++;   if (___v5897926 % 100 == 0) { await QB.autoLimit(); }
...
if (QB.halted()) { return; }; 
   ...
   var i = 0;  /* INTEGER */ 
   var ___v9276165 = 0; ___l1698735: for ( i=  1;  i <= (QB.func_UBound(  pairs));  i= i + 1) { if (QB.halted()) { return; } ___v9276165++;   if (___v9276165 % 100 == 0) { await QB.autoLimit(); }
...
var RemoveSuffix = null;
   ...
   i =  (QB.func_Len(  vname));
   var ___v4438625 = 0; ___l979298: while (~ done) { if (QB.halted()) { return; }___v4438625++;   if (___v4438625 % 100 == 0) { await QB.autoLimit(); }
...
var IsJSReservedWord = null;
   ...
   var ___v8725469 = 0; ___l2729468: for ( i=  1;  i <= (QB.func_UBound(  jsReservedWords));  i= i + 1) { if (QB.halted()) { return; } ___v8725469++;   if (___v8725469 % 100 == 0) { await QB.autoLimit(); }
...
var Join = null;
   ...
   var s = '';  /* STRING */ 
   var i = 0;  /* INTEGER */ 
   var ___v2729424 = 0; ___l7506877: for ( i=  startIndex;  i <=  endIndex;  i= i + 1) { if (QB.halted()) { return; } ___v2729424++;   if (___v2729424 % 100 == 0) { await QB.autoLimit(); }
...
var Replace = null;
   ...
   var ___v2566289 = 0; ___l6736467: for ( i=  1;  i <= (QB.func_Len(  s));  i= i + 1) { if (QB.halted()) { return; } ___v2566289++;   if (___v2566289 % 100 == 0) { await QB.autoLimit(); }
...
var MethodJS = null;
   ...
   var c = '';  /* STRING */ 
   var a = 0;  /* INTEGER */ 
   var ___v309506 = 0; ___l898966: for ( i=  1;  i <= (QB.func_Len(  m.name));  i= i + 1) { if (QB.halted()) { return; } ___v309506++;   if (___v309506 % 100 == 0) { await QB.autoLimit(); }
...
var GXMethodJS = null;
   ...
   var c = '';  /* STRING */ 
   var a = 0;  /* INTEGER */ 
   var ___v7901289 = 0; ___l3227177: for ( i=  startIdx +  1;  i <= (QB.func_Len(  mname));  i= i + 1) { if (QB.halted()) { return; } ___v7901289++;   if (___v7901289 % 100 == 0) { await QB.autoLimit(); }
