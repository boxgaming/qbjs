...
CodeMirror.defineMode("qbjs", function(conf, parserConf) {
    ...
    var commonkeywords = ['dim', 'as', 'redim', 'then', 'until', 'exit', 'to', 'let', 'common',
    ...
    var builtinFuncsWords = ['_?acos', '_?acosh', '_?alpha', '_?alpha32', '_?arccot', '_?arccsc', '_?arcsec',
                             ...
                             'abs', 'asc', 'atn', 'beep',
                             'chr', 'cdbl', 'cint', 'clng', 'csng', 'circle', 'cls', 'color', 'command', 'cos', 'cvi', 'cvl', 'cvs', 'cvd',
                             'data', 'date', 'draw', 'environ', 'error', 'exp', 'fix', 'hex', 'input', 'inkey', 'instr', 'int',
                             'lbound', 'left', 'lcase', 'len', 'line', 'loc', 'locate', 'log', 'ltrim', 'mid', 'mki', 'mkl', 'mks', 'mkd',
                             'oct', 'paint', 'play', 'point', 'preset', 'print','pset',
                             'right', 'rtrim', 'randomize', 'read', 'restore', 'rnd',
                             'screen', 'shared', 'sgn', 'sin', 'sleep', 'sound', 'space', 'sqr', 'static',
    ...
    var knownMethods = ['gxongameevent', 'gxmousex', 'gxmousey', 'gxsoundload', 'gxsoundplay', 'gxsoundrepeat', 'gxsoundvolume', 'gxsoundpause', 'gxsoundstop',
                        ...
                        'gxscenefollowentity', 'gxsceneconstrain', 'gxscenestop', 'gxentitysequences', 'gxentitysequence',
                        'gxmapcreate', 'gxmapcolumns', 'gxmaprows', 'gxmaplayers',
